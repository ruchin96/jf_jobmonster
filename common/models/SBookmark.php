...
class SBookmark extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['bookmark_id_job'], 'exist', 'skipOnError' => true, 'targetClass' => CJobfinder::className(), 'targetAttribute' => ['bookmark_id_job' => 'jobfinder_id']],
        ];
    }
    ...
    {
        return $this->hasOne(CJobfinder::className(), ['jobfinder_id' => 'bookmark_id_job']);
    }
}
